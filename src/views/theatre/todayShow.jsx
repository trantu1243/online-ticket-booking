                                ...
                                <table className="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                                    <thead>
                                        <tr className="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th className="text-end min-w-100px">Screen</th>
                                            <th className="text-end min-w-70px">Movie</th>
                                            <th className="text-end min-w-100px">Date</th>
                                            <th className="text-end min-w-100px">Time</th>
                                    ...
                                    <tbody className="fw-semibold text-gray-600">
                                        <tr>
                                            ...
                                            <td className="text-end pe-0">
                                                <span className="text-gray-800">Screen 01</span>
                                            </td>
                                            <td className="text-end pe-0">
                                            ...
                                            <td className="text-end pe-0">
                                                <span className="text-gray-800">15h-18h</span>
                                            </td>
