...
import { theaterSignIn } from "../theatre.auth.slice";

function TheatreSignIn(){
    ...
    async function handleClick(event){
        ...
        try {
            ...
            const response = await fetch(`${SERVER_URL}/theatre/login.php`, {
                method: 'POST',
                body: formData,
            });
            ...
            if (data.message === 'Ok'){
                ...
                localStorage.setItem('theatreToken', token);
                localStorage.setItem('theatreUsername', data.username);
                dispatch(theaterSignIn({token: token, username: data.username}));
